...
class NeuralNetwork(object):
    ...
    def backpropagation(self, final_outputs, hidden_outputs, X, y, delta_weights_i_h, delta_weights_h_o):
        ...
        # for the calculation of the output error term it's necessary to derivate 
        # the output activation function f(x)=x => f'(x)=1
        ...
        #print('The multiplication is:\n {}'.format(output_error_term*hidden_outputs[:,None]))
        #print('The sum term is:\n {}'.format(delta_weights_h_o))
